...
--
-- Table structure for table `paiement_formations`
--
...
--
-- Indexes for table `paiement_formations`
--
...
--
-- AUTO_INCREMENT for table `paiement_formations`
--
ALTER TABLE `paiement_formations`
...
--
-- AUTO_INCREMENT for table `recus`
--
ALTER TABLE `recus`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

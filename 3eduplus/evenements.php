      ...
      <div class="container">
          <div class="events-grid" id="eventsGrid">
           <div class="event-card" data-type="online">
                  ...
                  <div class="event-category">'.$categorie .'</div>
                  <h3 class="event-title">'.$titreEv .': '.$type_event.'</h3>
                  <p class="event-instructor">Par '.$instructeur.'</p>
                  ...
                  <div class="event-details">
                      ...
                      <div class="event-detail">
                          ...
                          <span>'.$heure_debut.'-'.$heure_fin.'</span>
                      </div>
                      <div class="event-detail">
                      ...
                      <div class="event-detail">
                          ...
                          <span>'.$inscrits .'/'.$capacite.' inscrits</span>
                      </div>
                  </div>

...
<head>
    ...
    <title>Marketing Dashboard - 3edu+</title>
    <link rel="stylesheet" href="../admin/style.css"> <!-- USES SHARED SLOTHUI STYLE -->
...
<body>
    <div class="dashboard-container">
        <!-- MARKETING SIDEBAR (Style matches Admin) -->
        <aside class="sidebar">
            <div class="sidebar-header">
                <div class="logo">
                     <img src="../../LogoEdu.png" alt="3edu+ Logo" style="max-height: 50px; filter: brightness(0) invert(1);"> 
                     <!-- filter added to make logo white on indigo bg if transparent, or just rely on image -->
                     <span class="logo-text" style="color: white;">3edu+</span>
                </div>
            </div>
        ...
        <main class="main-content">
            <!-- MARKETING HEADER (Uses shared admin header for consistency) -->
